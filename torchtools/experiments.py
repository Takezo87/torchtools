...
__all__ = ['df_fn', 'df_dir', 'df_path', 'trn_end', 'val_end', 'test_end', 'splits', 'df_config', 'col_config',
           'df_source', 'dataset_name', 'data_params', 'emb_sz_rule', 'get_emb_sz', 'get_dls', 'run_training', 'arch',
           'n_epochs', 'max_lr', 'wd', 'loss_fn_name', 'alpha', 'metrics', 'N', 'magnitude', 'seed', 'pct_start',
           'div_factor', 'aug', 'train_params', 'get_recorder_dict', 'TSExperiments', 'build_data_params', 'main',
           'COL_CONFIG']
...
#     model = arch(6,1)
    ...
    model = _get_model(self.dls, arch=arch)
