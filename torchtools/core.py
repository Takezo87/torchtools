...
__all__ = ['test', 'leaky_loss', 'leaky_loss_squared', 'double_loss', 'gamblers_loss', 'leaky_loss_2d', 'one_hot',
           'create_rww_categorical_crossentropy', 'ahc_fp_weights', 'ahc_rww_loss', 'unweighted_profit', 'gl_profit',
           'combo_profit', 'quantile_profit', 'top_10', 'bottom_10', 'top_quantile_double', 'top10_double',
           'top5_double', 'unweighted_profit_05', 'weighted_profit', 'get_loss_fn', 'get_loss_fn_class', 'is_array',
           'listify', 'map_xs', 'FixedSplitter', 'TSSplitter']
...
def top_quantile_double(preds, y_true, quantile=0.9):
    ...
    m_value = (y_true[idxs_over, 0].sum() + y_true[idxs_under, 1].sum()) / preds.shape[0]
    return m_value
