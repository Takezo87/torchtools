# AUTOGENERATED! DO NOT EDIT! File to edit: 120_augmentations.ipynb (unless otherwise specified).

__all__ = ['noise_from_random_curve', 'noise_from_normal', 'distort_time', 'TSRandomResizedCrop', 'AugTransform',
           'YWarp', 'YNormal', 'YNormalMul', 'YScale', 'YScaleChannel', 'TimeWarp', 'TimeNormal', 'encodes', 'encodes',
           ...
           'RandAugment', 'Augmix', 'AugmixSS', 'TSBlur', 'encodes', 'maddest', 'TSWaveNoise', 'encodedes', 'TSDenoise',
           'encodedes']
